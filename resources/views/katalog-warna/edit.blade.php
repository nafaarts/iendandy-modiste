...
@section('content')
    <div class="container-fluid">
        <div class="card mb-4">
            ...
            <form action="{{ route('katalog.warna.update', [$katalog, $warna]) }}" method="post"
                ...
                <div class="card-body">
                        ...
                        <label for="gambar" class="d-block">
                            <div class="card overflow-hidden d-flex justify-content-center align-items-center  @error('gambar') border border-danger @enderror"
                                ...
                                <img id="frame" class="img-fluid"
                                    src="{{ asset('/storage/img/katalog/' . $warna->gambar) }}" alt="selected image">
                            </div>
                        </label>
                        @error('gambar')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control  @error('nama') is-invalid @enderror"
                            placeholder="Masukan nama" value="{{ old('nama', $warna->nama) }}">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stok" class="form-control @error('stok') is-invalid @enderror"
                            placeholder="Masukan stok" value="{{ old('stok', $warna->stok) }}">
                        @error('stok')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
